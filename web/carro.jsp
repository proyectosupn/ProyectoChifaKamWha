    ...
    <div class="l-main ed-container">
        <div class="ed-item">
                ...
                <div class="producto-carro">
                    ...
                    <div class="producto-carro__del">
                        <a href="EliminarCarrito?id=<%= menu.getMenuID()%>">
                            <img src="imagenes/delete.png" alt="Eliminar" title="Eliminar">
                        </a>
                    </div>
            ...
            <div class="producto-carro__footer">
                <div class="">
                    <a class="boton icon-cart espacio product__page__buy" href="/PryChifa/index.jsp">Seguir Comprando</a>
                </div>
            ...
            <form method="post" action="VenderCarrito" class="ed-container web-60 contact-form">
