...
public class VentaDAOImpl {
    ...
    private BoletaModel insertarBoleta(ClienteModel cliente){
        BoletaModel boleta = null;
        ...
        try{
            ...
            boleta = listarBoletaCliente(cliente);
    ...
    private BoletaModel listarBoletaCliente(ClienteModel cliente){
        BoletaModel boleta = null;
        PreparedStatement pst;
        ResultSet rs = null;
        try{
            pst = cn.getCn().prepareCall("{ Call listarBoletaCliente(?) }");
            ...
            while(rs.next()){
                ...
                boleta.getCliente().setClienteID(rs.getString(3));
            }
